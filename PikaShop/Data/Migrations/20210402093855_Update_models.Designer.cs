...
namespace PikaShop.Data.Migrations
{
    ...
    [Migration("20210402093855_Update_models")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PikaShop.Models.User_CommentPost", b =>
                {
                    b.HasBaseType("Microsoft.AspNetCore.Identity.IdentityUser");

                    b.HasDiscriminator().HasValue("User_CommentPost");
                });

            modelBuilder.Entity("PikaShop.Models.User_Order", b =>
                {
                    b.HasBaseType("Microsoft.AspNetCore.Identity.IdentityUser");

                    b.HasDiscriminator().HasValue("User_Order");
                });

            modelBuilder.Entity("PikaShop.Models.User_RatingProduct", b =>
                {
                    b.HasBaseType("Microsoft.AspNetCore.Identity.IdentityUser");

                    b.HasDiscriminator().HasValue("User_RatingProduct");
                });
            ...
            modelBuilder.Entity("PikaShop.Models.CommentPost", b =>
                {
                    b.HasOne("PikaShop.Models.User_CommentPost", "ApplicationUser")
                        .WithOne("CommentPost")
            ...
            modelBuilder.Entity("PikaShop.Models.Order", b =>
                {
                    b.HasOne("PikaShop.Models.User_Order", "ApplicationUser")
                        .WithOne("Order")
                        .HasForeignKey("PikaShop.Models.Order", "ApplicationUserId");
            ...
            modelBuilder.Entity("PikaShop.Models.RatingProduct", b =>
                {
                    b.HasOne("PikaShop.Models.User_RatingProduct", "ApplicationUser")
                        .WithOne("RatingProduct")
                        .HasForeignKey("PikaShop.Models.RatingProduct", "ApplicationUserId");
